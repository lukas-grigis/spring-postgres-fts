...
\echo '=== 1. LEXICAL: stemmed match over the stored tsvector, ranked by cover density ==='
...
\echo '=== 2. LEXICAL: websearch_to_tsquery is the parser you can hand a search box ==='
...
\echo '=== 3. LEXICAL: ts_rank and ts_rank_cd disagree on the same match set ==='
...
\echo '=== 4. FUZZY: the stemmer cannot reach a misspelling, trigrams can ==='
...
\echo '=== 5. SYNONYM: a query word that appears in no book still returns six ==='
