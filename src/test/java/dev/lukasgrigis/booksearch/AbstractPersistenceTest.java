...
/**
 * Base for everything that asserts Postgres behavior: the retrievers, the ranking functions, the
 ...
 * embedded database, which would take the Postgres-specific behavior under test with it.
 * <p>
