...
meaningful *relative to other rows for the same query*.
...
through the same configuration. So listing a pair in both directions is self-cancelling — though not in the way it
